...
private const val SCHEME = "ssl://"
private const val HOST = "${SCHEME}26be51e969a54e51ac54ce311ddc8b8d.s1.eu.hivemq.cloud:$PORT"
private const val CLIENT_ID = "slmiot"
private const val TOPIC = "wokwi-weather"
...
fun ChatScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.initializeMqtt(context, HOST, CLIENT_ID, TOPIC)
    }
